...
export function formatCacheTime(value: string | null): string {
  if (!value) return "n/a";
...
export function joinMessageSections(sections: Array<string | null | undefined | false>): string {
  return sections
...
function buildSummaryBlock(
  result: Awaited<ReturnType<typeof getBuyScanResult>>,
...
export function buildBuyCommandMessage(
  result: Awaited<ReturnType<typeof getBuyScanResult>>,
  mode: BuyScanMode,
  cacheUpdatedAt: string
): string {
